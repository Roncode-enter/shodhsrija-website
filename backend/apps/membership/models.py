...
class MembershipApplication(TimeStampedModel):
    ...
    def total_amount(self):
        """Calculate total payment amount based on tier and duration"""
...
class Payment(TimeStampedModel):
    ...
    # Related Objects
    membership_application = models.ForeignKey(MembershipApplication, on_delete=models.CASCADE, 
                                             null=True, blank=True, related_name='payments')
    # donation will be linked when we create the donations app
...
class SkillCategory(TimeStampedModel):
    """Predefined skill categories for membership applications"""
...
class MembershipBenefit(TimeStampedModel):
    """Benefits associated with membership tiers"""
    name = models.CharField(max_length=200)
    description = models.TextField()
    icon = models.CharField(max_length=50, default='check_circle')
    tiers = models.ManyToManyField(MembershipTier, related_name='membership_benefits')
    order = models.PositiveIntegerField(default=0)
    is_active = models.BooleanField(default=True)
...
class MemberActivity(TimeStampedModel):
    ...
    member = models.ForeignKey(User, on_delete=models.CASCADE, related_name='member_activities')
    activity_type = models.CharField(max_length=20, choices=ACTIVITY_TYPES)
    title = models.CharField(max_length=200)
    description = models.TextField()
    date = models.DateField()
    hours = models.PositiveIntegerField(default=0, help_text="Hours contributed")
    points = models.PositiveIntegerField(default=0, help_text="Points earned")
    certificate = CloudinaryField('certificates', null=True, blank=True)
